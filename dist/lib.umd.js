(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('vue')) } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports['lib'] = factory(require('vue')) } else { root['lib'] = factory(root['Vue']) }
 ...
 */
   ...
   */
        open: function open(config) {
          ...
          var defaults = getDefaultStyle(config.type) // 如果存在一个loading，则清除上一个 ---- 该功能待定
 ...
 */
      ...
      var version = '0.4.1' // init components
